...
export const getUserInfo = (username) => {
    return { type: GET_USER_INFO, payload: username }
}
...
export const SaveBasicInfo = (incident) => {
    return { type: SAVE_BASIC_INFO, payload: incident }
}
